...
public class DateTimeLogic {
	...
	ArrayList<String> availableTimes = new ArrayList<>(List.of("Not Selected", "09:00 AM", "10:00 AM", "11:00 AM", "12:00 PM", "01:00 PM", "02:00 PM", "03:00 PM", "04:00 PM"));
	...
	public String[] returnStartTimes(){
	    ...
	    for (int i = 1; i < availableTimesCopy.size(); i++) {
	      try {
	        Date dateToCheck = new SimpleDateFormat("dd/MM/yyyy").parse(availableTimesCopy.get(i).substring(0,1) + "/" + month + "/" + year);
